    ...
    <footer id="contacto" className="py-32 bg-background text-white relative overflow-hidden border-t border-slate-900">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center space-y-12">
        <div className="space-y-6 max-w-3xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-headline font-semibold tracking-tighter leading-tight">
        ...
        <ContactModal>
          <Button size="lg" className="h-14 sm:h-16 px-6 sm:px-12 text-sm sm:text-lg font-mono font-medium rounded-none bg-primary text-black hover:bg-white hover:text-primary transition-all shadow-[0_0_40px_-10px_rgba(var(--primary-rgb),0.3)] tracking-widest uppercase w-full sm:w-auto">
            Agendar Auditoría Técnica
          </Button>
        </ContactModal>

        <div className="pt-16 md:pt-24 grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-12 border-t border-slate-900 mt-16 md:mt-24 text-left">
          ...
          <div className="col-span-2 space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-2 text-[10px] font-mono uppercase tracking-[0.2em] text-emerald-500">
          ...
          <div className="col-span-1 space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://www.tiktok.com/@logic_it" target="_blank" rel="noopener noreferrer" className="text-sm text-slate-500 hover:text-white transition-colors">TikTok</a>
              <a href="mailto:logicit2020@gmail.com" className="text-sm text-slate-500 hover:text-white transition-colors">Email</a>
            </div>
          </div>
